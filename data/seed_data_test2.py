...
def create_email_database():
    ...
    conn.commit()
    conn.close()
    print("✅ Email database created and seeded for Test Case 2")
...
def create_calendar_database():
    ...
    conn.commit()
    conn.close()
    print("✅ Calendar database created and seeded for Test Case 2")
...
def create_slack_database():
    ...
    conn.commit()
    conn.close()
    print("✅ Slack database created and seeded for Test Case 2")
...
def create_kanban_database():
    ...
    conn.commit()
    conn.close()
    print("✅ Kanban database created and seeded for Test Case 2")
...
def create_github_database():
    ...
    conn.commit()
    conn.close()
    print("✅ GitHub database created and seeded for Test Case 2")

def main():
    """Main function to create all databases for Test Case 2"""
    print("🚀 Starting Test Case 2 database creation and seeding...")
    print("📅 OOO Period: 2024-01-07 to 2024-01-14 (7 days)")
    print()
    ...
    print()
    print("✅ Test Case 2 databases created and seeded successfully!")
    print("📊 Summary:")
    print("   - Email database: 20 emails (4 important, 16 noise) - 80% noise ratio")
    print("   - Calendar database: 20 events (4 important, 16 noise) - 80% noise ratio")
    print("   - Slack database: 20 messages (4 important, 16 noise) - 80% noise ratio")
    print("   - Kanban database: 20 tasks (4 important, 16 noise) - 80% noise ratio")
    print("   - GitHub database: 8 commits, 4 PRs, 3 issues, 2 code reviews (2 important, 6 noise) - 75% noise ratio")
    print()
    print("🎯 Test Case 2: 7-day OOO period with mid-January context and business scenarios")
